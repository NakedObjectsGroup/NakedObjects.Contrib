...
namespace NakedObjects.XmlStore.XmlTest {
    [TestFixture]
    public class XmlTestSuite : AcceptanceTestCase {
        ...
        private static string TestDataDirectoryName {
            get { return Path.Combine(new DirectoryInfo(".").FullName, "XmlTestSuiteTestData"); }
        }

        protected override IObjectPersistorInstaller Persistor {
            get { return new XmlPersistorInstaller(TestDataDirectoryName, false); }
        }

        protected void ClearOldTestData() {
            string testDir = Utils.Path(TestDataDirectoryName, false);
        ...
        protected override IServicesInstaller MenuServices {
            get { return new ServicesInstaller(new object[] {new SimpleRepository<TestData.Person>()}); }
        }
        ...
        [Test, Ignore("This test doesn't run for XML because XML does update the key when submitting")]
